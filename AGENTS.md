...
- Phase 10 - Lightroom:
  ...
  trägt Version `0.4.12.0`: Das kompakte schwebende Zuweisungsfenster bleibt bei Auswahlwechseln geöffnet,
  ...
  Stichwort nicht zweimal anlegen oder zuweisen. Version 0.4.12.0 ruft den Lightroom-Schreibcallback ohne den in
  ...
  `LrTasks.pcall` innerhalb der Lightroom-Task abgesichert. Die
