...
- Phase 10 - Lightroom:
  ...
  trägt Version `0.4.13.0`: Das kompakte schwebende Zuweisungsfenster bleibt bei Auswahlwechseln geöffnet,
  ...
  Stichwort nicht zweimal anlegen oder zuweisen. Version 0.4.13.0 ruft den Lightroom-Schreibcallback ohne den in
  ...
  No-op darf deshalb keine Erfolgsmeldung mehr erzeugen. Die gesamte Write-Access-Operation bleibt mit
  `LrTasks.pcall` innerhalb der Lightroom-Task abgesichert. Sie korrigiert außerdem den fehlerhaften
  Callback-Abschluss aus 0.4.12.0, durch den `KeywordWriter.lua` nicht geladen werden konnte. Die
