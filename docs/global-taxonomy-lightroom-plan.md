...
10.2 bis 10.4 sind bis Plug-in-Version 0.4.12.0 umgesetzt und automatisiert geprüft. Einzel- und Mehrfachzuweisung,
Fensteraufbau, Favoritenersetzung und Taxonomierücknahme wurden im separaten Lightroom-Testkatalog praktisch
geprüft; der 0.4.12.0-Reparaturstand benötigt noch den praktischen Folgetest. Phase 10 bleibt bis zum
...
- **Bis Plug-in-Version 0.4.12.0 am 2026-08-29 umgesetzt und automatisiert geprüft; grundlegende Einzel- und
  Mehrfachzuweisung praktisch bestätigt, der 0.4.12.0-Reparaturstand noch nicht praktisch abgenommen.**
...
- Vor dem Lightroom-Schreibzugriff entsteht aus den sichtbaren `(FN)`-Namen eine eindeutige Liste. Gleich benannte
  ...
  Version 0.4.12.0 entfernt den optionalen Timeout aus 0.4.11.0 und prüft vor einer Erfolgsmeldung Callback-Abschluss
  sowie gespeicherte `masterTaxonId`, damit ein nicht ausgeführter Schreibcallback nicht als Erfolg gilt.
...
im Testkatalog bestätigt. Phase 10.3/10.4 ergänzen bis Version 0.4.12.0 die nutzergeführte Rücknahme, dynamische
