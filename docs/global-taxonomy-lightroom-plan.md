...
10.2 bis 10.4 sind bis Plug-in-Version 0.4.11.0 umgesetzt und automatisiert geprüft. Einzel- und Mehrfachzuweisung,
Fensteraufbau, Favoritenersetzung und Taxonomierücknahme wurden im separaten Lightroom-Testkatalog praktisch
geprüft; der 0.4.11.0-Reparaturstand benötigt noch den praktischen Folgetest. Phase 10 bleibt bis zum
...
- **Bis Plug-in-Version 0.4.11.0 am 2026-08-29 umgesetzt und automatisiert geprüft; grundlegende Einzel- und
  Mehrfachzuweisung praktisch bestätigt, der 0.4.11.0-Reparaturstand noch nicht praktisch abgenommen.**
...
- Vor dem Lightroom-Schreibzugriff entsteht aus den sichtbaren `(FN)`-Namen eine eindeutige Liste. Gleich benannte
  ...
  meldet einen anderweitig belegten Katalog verständlich. Alle yieldenden SDK-Schreibaufrufe verwenden
  `LrTasks.pcall`; damit ist die in Version 0.4.10.0 fehlerhaft verwendete normale Lua-`pcall`-Grenze beseitigt.
...
im Testkatalog bestätigt. Phase 10.3/10.4 ergänzen bis Version 0.4.11.0 die nutzergeführte Rücknahme, dynamische
