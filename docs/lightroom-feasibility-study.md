...
Stand: 2026-08-29
Roadmap: Phase 10.1  
Status: Phase 10.1 abgeschlossen; Suchpaket, produktive Zuweisung und Ausbau bis Plug-in-Version 0.4.16.0 sind unter
...
Plug-in-Version 0.4.16.0 ergänzt die vollständigen lesbaren Plug-in-Metadaten, eindeutig markierte flache
...
0.4.16.0 über eine kurze `LrTask`, damit die Fotozahl unmittelbar aktualisiert wird. Die erneute SDK-Prüfung am
